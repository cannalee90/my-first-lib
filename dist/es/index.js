...
var BodySizeType;
(function (BodySizeType) {
    BodySizeType["HEIGHT_AS_CENTI_METER"] = "HEIGHT_AS_CENTI_METER";
    BodySizeType["WEIGHT_AS_KILO_GRAM"] = "WEIGHT_AS_KILO_GRAM";
    BodySizeType["TOP_SIZE"] = "TOP_SIZE";
    BodySizeType["BOTTOM_SIZE_AS_INCH"] = "BOTTOM_SIZE_AS_INCH";
    BodySizeType["SHOE_SIZE_AS_MILLI_METER"] = "SHOE_SIZE_AS_MILLI_METER";
})(BodySizeType || (BodySizeType = {}));
const bodySizeType = (() => {
    const label = {
...
const birthYearPolicy = {
    min: new Date().getFullYear() - 80,
    max: new Date().getFullYear() - 20,
    step: 1,
    unit: '년',
};
function generateBodySizeOptions(policy, minSuffix, maxSuffix, useUnitInLabel = false) {
    const { min, max, step, unit } = policy;
    return range$1(min, max + step, step)
        .map((value) => {
        const label = (() => {
...
function isValidValue(policy, value) {
    if (value === undefined) {
        return false;
    }
...
const UserBodySizeData = (() => {
    function hasFilledAllBodySize(bodySize) {
    ...
    function makeDraftBodySize(bodySize) {
        return {
    ...
    function makeFinalBodySize(bodySize) {
        const getFinalValue = (v) => v === 0 ? undefined : v;
        return {
...
export { BodySizeType, UserBodySizeData, birthYearPolicy, bodySizeType, bottomSizePolicy, generateBodySizeOptions, heightPolicy, isValidValue, shoeSizePolicy, topSizePolicy, weightPolicy };
